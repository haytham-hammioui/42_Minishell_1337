...
SRCS = mandatory/minishell.c		\
		...
		mandatory/built-ins/export.c mandatory/built-ins/utils/ft_lstadd_back.c mandatory/env/create_env.c mandatory/built-ins/env.c mandatory/built-ins/pwd.c mandatory/built-ins/cd.c mandatory/built-ins/echo.c mandatory/built-ins/unset.c mandatory/built-ins/handle_built_in.c mandatory/built-ins/utils/ft_putstr_fd_bonus.c \
